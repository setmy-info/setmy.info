...
public class PolicyDirectiveTest {
    ...
    public void nameForNullNameConstructor() {
        ...
        assertThat(policyDirective.getName()).isEqualTo("");
    }

    @Test
    public void makeingString() {
        policyDirective.add(SELF);
        assertThat(policyDirective.toString()).isEqualTo("script-src 'self'");
    }
    ...
    public void makeingStringFromMultipleString() {
        ...
        assertThat(policyDirective.toString()).isEqualTo("script-src 'self' setmy.info www.hearandseesystems.com");
    }
    ...
    public void clearingFromAddedValuesShouldCreateEmptyString() {
        ...
        assertThat(policyDirective.toString()).isEqualTo("");
    }
    ...
    public void makeingSHA256String() {
        ...
        assertThat(policyDirective.toString()).isEqualTo("script-src 'sha256-NTM5ZGQwM2JhZTE0NDRmM2NhZDA1ODdiYjZjYWI0NDAwMDgwOWU4ZWJjMmViM2RjZTQ2ZTgwYmYyY2I0ZWYxYg=='");
    }
    ...
    public void makeingSHA384String() {
        ...
        assertThat(policyDirective.toString()).isEqualTo("script-src 'sha384-QjM3RjIwMkM5MUE1ODE3NTRDNjdBNTExMTFGRkI3MEU4MkFBNzA5QURFRjEyNDM4ODkwMEEyMzEyNDRGRTg4NjM2MzA1OTg5MDE5QTQzODMyRDQ5NzYwRTIyODQxMzQ5'");
    }
    ...
    public void makeingSHA512String() {
        ...
        assertThat(policyDirective.toString()).isEqualTo("script-src 'sha512-MTUxRkJEOUZEQUQ1RUQzNUU0MkQ4MkE5MkJENUExM0ExMDc1MjE5Qjk0ODBBMzg5RTNEQjBDREY2ODYzOUE0NEI4RTIwMDdFODg3MDI1Q0I5MDc4MTQyMTFCRjk2NjQ1OEJGM0I3OTc4Q0I0OTAxRTkyQUE3ODVDRTVENTEyMzc='");
    }
    ...
    public void makeingNonceString() {
        ...
        assertThat(policyDirective.toString()).isEqualTo("script-src 'nonce-2726c7f26c'");
    }
}
