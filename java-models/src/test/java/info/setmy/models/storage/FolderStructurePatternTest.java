...
public class FolderStructurePatternTest {
    ...
    public void fillingYearAndMonthAndDayAndHourAndMinute() {
        ...
        assertThat(folderStructurePattern.toString()).isEqualTo("2018/12/31/23/59");
    }
    ...
    public void fillingYearAndMonthAndDayAndHourAndMinuteAndSecond() {
        ...
        assertThat(folderStructurePattern.toString()).isEqualTo("2018/12/31/23/59/59");
    }
    ...
    public void fillingYearAndMonthAndDayAndHourAndMinuteAndSecondAndMilliSecond() {
        ...
        assertThat(folderStructurePattern.toString()).isEqualTo("2018/12/31/23/59/59/1234");
    }

    @Test
    public void addDate() {
        folderStructurePattern.setDate(getDate(), DirectoryStructureDepth.MILLISECOND);
        assertThat(folderStructurePattern.toString()).isEqualTo("2017/12/31/8/18/10/252");
    }
