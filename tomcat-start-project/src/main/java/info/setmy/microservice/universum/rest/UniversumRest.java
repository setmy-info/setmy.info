...
public class UniversumRest {
    ...
    /**
     * REST call GET : http://localhost:8777/tomcat-start-project-1.2.0-SNAPSHOT/rest/universum/1
     * 
    ...
    // REST Call GET : http://localhost:8777/tomcat-start-project-1.2.0-SNAPSHOT/rest/universum
    @GET
    @Produces(APPLICATION_JSON)
